...
describe('validateGraphProperties', () => {
  describe('Basic validation', () => {
    it('should validate a simple tree graph', () => {
      ...
      expect(result.properties).toHaveLength(47); // All 47 validation functions (17 + 3 Phase 1 + 5 Phase 2 + 3 Phase 3 + 2 Phase 4 + 5 Phase 5 + 2 Phase 6 + 7 Phase 1 v2 + 3 Phase 2 v2)
    });
