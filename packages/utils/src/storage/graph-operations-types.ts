...
export interface GraphListOperationsInterface {
   ...
   * @throws Error if the graph list is full
   */
  addToGraphList: (params: Readonly<AddToGraphListParams>) => Promise<string>;
   ...
   */
  batchAddToGraphList: (nodes: readonly AddToGraphListParams[]) => Promise<string[]>;
}
...
export interface GraphSnapshotOperationsInterface {
   ...
   */
  addSnapshot: (snapshot: Readonly<Omit<GraphSnapshotStorage, 'id' | 'createdAt' | 'updatedAt'>>) => Promise<string>;
   ...
   */
  updateSnapshot: (snapshotId: string, updates: Readonly<Partial<Omit<GraphSnapshotStorage, 'id' | 'createdAt' | 'updatedAt'>>>) => Promise<void>;
