export const shadcnPalettes = {
  ...
  lime: [
    ...
    '#84cc16', '#65a30d', '#4d7c0f', '#365314', '#1a2e05', '#052e16'
  ],
  green: [
  ...
  purple: [
    ...
    '#a855f7', '#9333ea', '#7c3aed', '#6b21a8', '#581c87', '#3b0764'
  ],
  fuchsia: [
...
export const getShadcnColor = (palette: ShadcnPalette, shade: ShadcnShade): string => {
  return shadcnPalettes[palette][shade]
}

export const shadcnSemanticColors = {
  light: {
    background: 'slate.0',
    foreground: 'slate.9',
    card: 'slate.0',
    'card-foreground': 'slate.9',
    popover: 'slate.0',
    'popover-foreground': 'slate.9',
    primary: 'stone.9',
    'primary-foreground': 'stone.0',
    secondary: 'zinc.1',
    'secondary-foreground': 'zinc.9',
    muted: 'zinc.1',
    'muted-foreground': 'zinc.5',
    accent: 'zinc.1',
    'accent-foreground': 'zinc.9',
    destructive: 'red.9',
    'destructive-foreground': 'red.0',
    border: 'zinc.2',
    input: 'slate.1',
    ring: 'stone.9',
  },
  dark: {
    ...
    foreground: 'slate.0',
    card: 'slate.10',
    'card-foreground': 'slate.0',
    popover: 'slate.10',
    'popover-foreground': 'slate.0',
    primary: 'stone.0',
    'primary-foreground': 'stone.9',
    secondary: 'zinc.3',
    'secondary-foreground': 'zinc.0',
    muted: 'zinc.3',
    'muted-foreground': 'zinc.5',
    accent: 'zinc.3',
    'accent-foreground': 'zinc.0',
    destructive: 'red.5',
    'destructive-foreground': 'red.0',
    border: 'zinc.8',
    input: 'slate.9',
