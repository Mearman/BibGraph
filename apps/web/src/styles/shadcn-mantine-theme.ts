...
import { shadcnMantineComponentsFeedback } from './shadcn-mantine-components-feedback'
import { shadcnMantineComponentsForms } from './shadcn-mantine-components-forms'
import { shadcnMantineComponentsInputs } from './shadcn-mantine-components-inputs'
import { shadcnMantineComponentsLayout } from './shadcn-mantine-components-layout'
...
export const shadcnMantineTheme = createTheme({
  ...
  components: {
    ...shadcnMantineComponentsInputs,
    ...shadcnMantineComponentsFeedback,
    ...shadcnMantineComponentsLayout,
    ...shadcnMantineComponentsForms,
  },
})