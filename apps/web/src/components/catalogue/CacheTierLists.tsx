/**
 * Cache Tier Lists component for displaying entities in each cache tier Shows synthetic system lists for Memory and IndexedDB cache tiers
 */
    ...
    <Stack gap="md">
      ...
      <SimpleGrid cols={{ base: 1, lg: 2 }} spacing="md">
        ...
        <CacheTierCard
          ...
          onRefresh={() => { void handleRefreshIndexedDB(); }}
          onClear={() => { void handleClearIndexedDB(); }}
          isPersistent={true}
      ...
      <SimpleGrid cols={{ base: 1, lg: 2 }} spacing="md">
        {staticConfig?.gitHubPages.isProduction === true && (
          <StaticCacheTierCard
            ...
            onRefresh={() => { void handleRefreshStatic(); }}
            color="grape"
            badges={
        ...
        {staticConfig?.gitHubPages.isLocalhost === true && (
          <StaticCacheTierCard
